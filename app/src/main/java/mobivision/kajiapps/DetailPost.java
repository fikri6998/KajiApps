...
import mobivision.kajiapps.adapter.AdapterComment;
...
public class DetailPost extends AppCompatActivity {
    ...
    TextView mUsername, mTitlePost, mPost, mUstadz, mLokasi, mWaktu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sUstadz = intent.getStringExtra("Ustadz");
        String sLokasi = intent.getStringExtra("Lokasi");
        String sWaktu = intent.getStringExtra("Waktu");
        ...
        mUstadz = findViewById(R.id.tv_ustadz);
        mWaktu = findViewById(R.id.tv_waktu);
        mLokasi = findViewById(R.id.tv_lokasi);
        ...
        mUstadz.setText(sUstadz);
        mLokasi.setText(sLokasi);
        mWaktu.setText(sWaktu);
    }
    ...
    public void addComment(View view) {
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                User user = dataSnapshot.child(cur_user.getUid()).getValue(User.class);
