...
import mobivision.kajiapps.view.AdapterPager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Info Kajian"));
        tabLayout.addTab(tabLayout.newTab().setText("Koleksi Kajian"));
