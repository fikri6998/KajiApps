...
public class AdapterUstadz extends RecyclerView.Adapter<AdapterUstadz.menuholder> {
    //DEKLARASI VARIABEL
    CardView cd;
    private Context context;
    private List<Ustadz> listmenu;

    //UNTUK LAYOUT DAFTAR ITEM
    public AdapterUstadz(Context context, List<Ustadz> listmenu){
    ...
    public menuholder onCreateViewHolder(ViewGroup parent, int viewType) {
        //buat view baru
        View view = LayoutInflater.from(context).inflate(R.layout.activity_ustadz_cardview, parent, false);
    ...
    public void onBindViewHolder (menuholder holder, int position) {
        Ustadz data = listmenu.get(position);
        ...
        public menuholder(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    //INTENT BARU
                    Intent i = new Intent(context, DetailUstadzActivity.class);
